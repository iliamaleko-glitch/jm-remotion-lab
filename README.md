...
- FPS: `60`
- Size: `1920x1080`
- Style: luxury black background, deep purple glow (`#7A3CFF`), minimal premium cinematic motion
- Implementation: procedural SVG/CSS gradients, transforms, and frame-driven Remotion animation; no images or heavy assets
